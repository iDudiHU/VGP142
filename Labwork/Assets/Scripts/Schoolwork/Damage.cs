    ...
    public class Damage : MonoBehaviour
{
    ...
    {
        HealthSystem collidedHealth = collision.gameObject.GetComponentInParent<HealthSystem>();
        if (collidedHealth == null && collision.rigidbody != null)
        {
            collidedHealth = collision.rigidbody.GetComponent<HealthSystem>();
        }
    ...
    private void DealDamage(Collider collision)
    {
        ...
        {
            collidedHealth = collision.attachedRigidbody.GetComponent<HealthSystem>();
        }
        if (collidedHealth != null)
        {
            if (collidedHealth.teamId != this.teamId)
